"""
Program to detect interspersed k-mers from paired-end output of k-seek files.

Will iterate through all k-seek paired-end outputs and extract the k-mer from the last line as well as record headers
for genome/fastq name that you must supply within code.
